 ...
 * 
 * @author Mr chen
 * @name : ExportOutPurchaseSummView
 * @todo : [采购汇总导出]
 * 
 *       创建时间 ： 2016年12月19日下午2:32:58
 */
public class ExportOutPurchaseSummView extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> arg0, HSSFWorkbook workbook, HttpServletRequest req,
		...
		String goodsKind = req.getParameter("goodsKind");
		...
		User user = (User) SessionUtil.getSession().getAttribute("user");
		 ...
		 List<PurchaseSumm> list = purchaseSummService.getOutExcelPurchaseSummList(stime, etime, user.getStructId(), user.getRoleId(),
				customerId,goodsNm,goodsKind,supplierId);
