 ...
 */
public class getToTalDMoneyByCustomersInDayAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getToTalDmoneyByCustomersInDay(stime, etime, user.getStructId(), customerIds, kindCode);
