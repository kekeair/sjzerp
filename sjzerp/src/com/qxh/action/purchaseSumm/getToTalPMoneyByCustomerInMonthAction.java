 ...
 */
public class getToTalPMoneyByCustomerInMonthAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getToTalPmoneyByCustomerInMonth(stime, etime, user.getStructId(), customerIds, kindCode);
