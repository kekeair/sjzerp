 ...
 * 
 */
public class getSelectBigKindForCostAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getSelectBigKindForCost(goodsNm, stime, etime, user.getStructId(), customerIds);
