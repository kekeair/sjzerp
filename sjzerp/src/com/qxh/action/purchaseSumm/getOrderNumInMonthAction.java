 ...
 * @Description:[为统计图表获取当年每月单物料数量]

 * @author:kekeair

 * @time:2017年3月17日 下午5:34:53

 */
public class getOrderNumInMonthAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getOrderNumInMonth(goodsId, goodsType, stime, etime, 
