 ...
 * 
 */
public class getOrderNumByCustomerInMonthAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getOrderNumByCustomerInMonth(stime, etime, user.getStructId(), customerIds, kindCode);
