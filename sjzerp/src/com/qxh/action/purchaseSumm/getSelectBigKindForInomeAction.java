 ...
 * 
 */
public class getSelectBigKindForInomeAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getSelectBigKindForIncome(goodsNm, stime, etime,
				user.getStructId(), customerIds);
