 ...
 */
public class getOrderNumByCustomerInDayAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getOrderNumByCustomerInDay(stime, etime, user.getStructId(), customerIds, kindCode);
