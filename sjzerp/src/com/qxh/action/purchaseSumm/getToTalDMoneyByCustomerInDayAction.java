 ...
 */
public class getToTalDMoneyByCustomerInDayAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getToTalDmoneyByCustomerInDay(stime, etime, user.getStructId(), customerIds, kindCode);
