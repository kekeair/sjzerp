...
public class GetCenterAvaiGoodsAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = supplierGoodsService.getCenterAvaiGoods(name,kindCode,
				leftPage,structId,supplierId,goodsCode);
