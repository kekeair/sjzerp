 ...
 */
public class getToTalPMoneyByCustomerInDayAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getToTalPmoneyByCustomerInDay(stime, etime, user.getStructId(), customerIds, kindCode);
