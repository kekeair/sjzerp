...
public class DelSupplierGoodsAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = supplierGoodsService.delSupplierGoods(supplierId,rightPage,
				supplierGoodsId,structId);
