 ...
 */
public class getToTalPMoneyByCustomersInDayAction extends MainAction implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		Result result = purchaseSummService.getToTalPmoneyByCustomersInDay(stime, etime, user.getStructId(), customerIds, kindCode);
