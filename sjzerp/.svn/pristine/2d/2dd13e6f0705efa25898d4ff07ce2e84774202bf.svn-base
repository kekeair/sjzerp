...
public class GoodsPriceInitAction extends MainAction implements Controller{
...
private CommonService commonService;
	...
	public ModelAndView handleRequest(HttpServletRequest req, 
		...
		getPowerRight(mav, user,CodeConstant.NAV_203,CodeConstant.NAV_2);
		...
		mav.setViewName("centerConfig/goodsPrice");
