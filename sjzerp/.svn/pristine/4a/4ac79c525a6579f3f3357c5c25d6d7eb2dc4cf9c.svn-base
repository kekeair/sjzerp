 ...
 * 
 * @author Mr chen
 * @name : PrintOutDemandDetailInitAction
 * @todo : [出库单详情列表页面]
 * 
 * 创建时间 ： 2017年1月7日下午3:31:19
 */
public class PrintOutDemandDetailInitAction extends MainAction implements Controller{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse arg1) throws Exception {
		...
		mav.setViewName("demand/DemandDetailViewNew");
